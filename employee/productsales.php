...
<form action ="insertprosales.php" method="post" id="f">
...
<option value="<?php echo $r['cid']?>"><?php echo $r['name']?></option><?php }?></select></td></tr>
...
?>
<td><select name="code"> <?php  while($r=$c->fetch()){?>
<option value="<?php echo $r['code']?>"><?php echo $r['code']?></option><?php }?></select></td></tr>
...
<tr><td><br /></td></tr>
<tr><td><input type="hidden" name="eid"  value="<?php echo $r['eid']?>" /> <?php echo $r['eid'] ?></td></tr>
